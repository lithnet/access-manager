...
namespace Lithnet.AccessManager.Server.UI
{
    public class ActiveDirectoryForestConfigurationViewModelFactory : IActiveDirectoryForestConfigurationViewModelFactory
    {
        ...
        {
            return new ActiveDirectoryForestConfigurationViewModel(model, dialogCoordinator, domainFactory, certificateProvider, directory, certificate2ViewModelFactory);
        }
    }
}
