...
$propertyAccessRule2 = new-object "System.DirectoryServices.ActiveDirectoryAccessRule" $serviceAccountSid, "ExtendedRight", "Allow", $fveRecoveryPasswordGuid, "Descendents", $fveRecoveryObjectGuid
