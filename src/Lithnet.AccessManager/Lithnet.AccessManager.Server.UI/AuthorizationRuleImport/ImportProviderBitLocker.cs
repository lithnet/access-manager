...
namespace Lithnet.AccessManager.Server.UI.AuthorizationRuleImport
{
    public class ImportProviderBitLocker : ImportProviderComputerDiscovery
    {
        ...
        public ImportProviderBitLocker(ImportSettingsBitLocker settings, ILogger<ImportProviderBitLocker> logger, IActiveDirectory directory, IComputerPrincipalProviderBitLocker provider)
