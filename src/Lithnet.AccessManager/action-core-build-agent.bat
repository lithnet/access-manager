...
REM ECHO [92mClearing 64-bit output directory[0m
REM IF EXIST "%outputdirx64Linux%" powershell -Command "& Remove-Item '%outputdirx64Linux%\*' -recurse -force" || exit /b %errorlevel%
